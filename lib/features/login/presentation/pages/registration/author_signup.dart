  ...
  Widget _buildDesktopFields() {
    return Column(
      children: [
        Row(
          children: [
            Expanded(child: _buildDropdownField('Title', titleOptions, (v) => tempAuthor.title = v)),
            SizedBox(width: 16),
            Expanded(flex: 2, child: _buildTextField('Full Name', (v) => tempAuthor.name = v)),
          ],
        ),
        SizedBox(height: 16),
        Row(
          children: [
            Expanded(flex: 2, child: _buildTextField('Email', (v) => tempAuthor.email = v)),
            SizedBox(width: 16),
        ...
        Row(
          children: [
            Expanded(child: _buildDropdownField('Designation', designationOptions, (v) => tempAuthor.designation = v)),
            SizedBox(width: 16),
            Expanded(child: _buildTextField('Specialization', (v) => tempAuthor.specialization = v)),
          ],
        ),
        SizedBox(height: 16),
        Row(
          children: [
            Expanded(child: _buildTextField('Specific Field of Study', (v) => tempAuthor.fieldOfStudy = v)),
            SizedBox(width: 16),
            Expanded(child: _buildTextField('Mobile', (v) => tempAuthor.mobile = v)),
          ],
        ),
        SizedBox(height: 16),
  ...
  Widget _buildMobileFields() {
    return Column(
      children: [
        ...
        _buildPasswordField(),
        SizedBox(height: 16),
        _buildDropdownField('Designation', designationOptions, (v) => tempAuthor.designation = v),
        SizedBox(height: 16),
        _buildTextField('Specialization', (v) => tempAuthor.specialization = v),
        SizedBox(height: 16),
        _buildTextField('Specific Field of Study', (v) => tempAuthor.fieldOfStudy = v),
        SizedBox(height: 16),
    ...
    if (formKey.currentState!.validate()) {
      if (tempAuthor.title == null || tempAuthor.title!.isEmpty) {
        ...
        context.read<LoginBloc>().add(
          LoginAuthorSignupEvent(author: tempAuthor) 
        );
      }
    }
  }
